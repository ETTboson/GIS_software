// src/core/ai/memory/memoryfilemanager.h
...
// ════════════════════════════════════════════════════════
//  MemorySearchResult
//  职责：描述一次记忆检索命中条目，供 AI 和 UI 侧回显使用。
// ════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════
//  MemoryFileManager
//  职责：统一管理 ET.md 与 memory/*.md 的扫描、读取、检索与写入。
//        对 ConversationContext 与 ToolCallDispatcher 提供记忆层基础能力。
//  位于 core/ai/memory/ 层。
// ════════════════════════════════════════════════════════
...
public:
     ...
     * @param_1 _strWorkDir: ET.md 与 memory/ 的扫描根目录
     */
